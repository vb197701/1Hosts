...
<details><summary><strong><i>variant 2</i></strong>:  <i>Moderately strict - may introduce sporadic <a href="./-data/lists/antiAllow.lst">minor breaks</a>, privacy-focused (e.g, blocks <code>graph.facebook.com</code>).</i></summary>
<table align="center">
<thead>
<tr>
<th>Client</th>
...
<h3 align="center"><id="Xtra"><strong><ins>1Hosts (Xtra)</ins> <sup>Beta</sup></strong></h3>
    <strong><i>variant 3</i></strong>: <i>Aggressive - stops emerging privacy threats dead! Built for power users who prioritize security above all. May (occasionally) break a thing or two.
</i>
<br><br>
...
> [!TIP]
> Start with Lite.<br>
> Use Pro for more blocking, Xtra if you’re tech-savvy and can troubleshoot.
>
